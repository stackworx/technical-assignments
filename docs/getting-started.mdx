...
### You should have been asked to complete on of the following technical assignments

- [ReactJs](reactjs/brief.md)
- [NodeJs](nodsejs/brief.md)
- [.Net Core](dotnet/brief.md)
